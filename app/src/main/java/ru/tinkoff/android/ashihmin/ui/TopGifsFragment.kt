...
class TopGifsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recycler = view.findViewById<RecyclerView>(R.id.top_gifs_recycler)
    ...
    private fun downloadTopGifsList() {
        NetworkService.getInstance()
            ?.getJSONApi()
            ?.getTopImagesList()?.enqueue(object : Callback<GifImageList> {
